...
public class FachadaP {
	...
	protected void isConnected() {
		...
		if (!response.equals("OK")) {
			JOptionPane.showMessageDialog(null, "ERROR: No se puede abrir conexión a la base de datos, por favor verifique los parametros de conexión. \n" + response, "Conexión BD",
